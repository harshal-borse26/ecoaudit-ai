...
const AuthLayout = ({ children, title, subtitle, maxWidth = "max-w-[420px]" }) => {
  return (
    <div className="min-h-screen w-full bg-slate-100/90 md:bg-gradient-to-br md:from-emerald-50/60 md:via-slate-100 md:to-teal-50/60 flex items-center justify-center p-4 sm:p-6 lg:p-8 py-8 sm:py-10 font-sans antialiased text-[#1E293B] selection:bg-[#2E7D32]/10 selection:text-[#2E7D32] relative">
