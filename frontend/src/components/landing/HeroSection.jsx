        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-8 items-center">
          ...
          <div className="lg:col-span-6 text-left space-y-6">
            ...
            >
              ...
              <span className="tracking-wide uppercase font-heading text-[10px] sm:text-[11px] font-extrabold text-[#2F5241]">
                AI-Powered Scope 1 & 2 Carbon Accounting
              </span>
            </motion.div>
            ...
            <motion.h1
              ...
              className="text-3xl sm:text-4xl xl:text-5xl font-extrabold tracking-tight text-[#152A38] leading-[1.12] font-heading"
            >
              Automate Carbon Accounting.<br />
              Ingest Utility Bills with AI.<br />
              <span className="text-[#2F5241] relative inline-block">
                Publish Audit-Ready ESG Reports.
                <span className="absolute bottom-1 left-0 right-0 h-1 bg-[#2E7D32]/20 rounded-full" />
              </span>
            </motion.h1>
            ...
            >
              EcoAudit AI combines Google Gemini Vision OCR with localized greenhouse gas protocol conversion metrics. Ephemerally ingest raw PDF statements or portal screenshots and output fully documented corporate ESG audits in minutes.
            </motion.p>
          ...
          <div className="lg:col-span-6 relative">
            <motion.div
              ...
              className="dash-card bg-white border border-[#DDDDD0] rounded-[32px] p-6 shadow-[0_20px_50px_rgba(21,42,56,0.08)] relative transition-transform duration-200"
            >
              ...
              <div className="flex items-center justify-between pb-4 mb-4 border-b border-[#DDDDD0]">
                ...
                <span className="px-2.5 py-1 rounded-full bg-[#EAF2ED] text-[#2F5241] text-[10px] font-extrabold border border-[#2F5241]/20 flex items-center gap-1.5">
              ...
              <div className="bg-[#EEEDDF]/30 p-4 rounded-2xl border border-[#DDDDD0]/60 mb-2 relative overflow-hidden text-left">
              ...
              <motion.div
                ...
                className="absolute -top-4 -left-4 sm:-left-6 bg-white p-3.5 rounded-2xl border border-[#DDDDD0] shadow-lg flex items-center gap-2.5 z-20 text-left"
              >
                ...
                <div>
                  ...
                  <span className="text-[9px] font-bold text-[#7A8597] block mt-1">
              ...
              <motion.div
                ...
                className="absolute -bottom-4 -right-4 sm:-right-6 bg-white p-3.5 rounded-2xl border border-[#DDDDD0] shadow-lg flex items-center gap-2.5 z-20 text-left"
              >
                ...
                <div>
                  ...
                  <span className="text-[9px] font-bold text-[#2E7D32] block mt-1">
                    ● Monitored & Active
                  </span>
                </div>
              </motion.div>
              ...
              <motion.div
                ...
                className="absolute top-1/2 -right-6 sm:-right-8 hidden sm:flex bg-[#152A38] text-[#E4E5DB] p-3.5 rounded-2xl border border-[#2F5241]/40 shadow-xl items-center gap-2.5 z-20 text-left"
              >
